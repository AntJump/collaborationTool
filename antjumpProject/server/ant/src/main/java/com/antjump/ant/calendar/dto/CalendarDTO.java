 ...
 * <pre>
 * Class : CalendarDTO
 * Comment: tbl_calendars DTO 클래스입니당
 * History
 * ================================================================
 * DATE             AUTHOR           NOTE
 * ----------------------------------------------------------------
...
public class CalendarDTO {
    ...
    private String explanation;                     /* 일정 설명 */
    private String calendarAlarmCycle;              /* 알림 주기 */
    ...
    private int fkMembersCalendars;                 /* 회원 번호 */
    private int fkSprintsCalendars;                 /* 스프린트 번호 */
    ...
    public CalendarDTO(int calendarId, String calendarName, Date calendarStartDate, Date calendarEndDate,
                       ...
                       String explanation, String calendarAlarmCycle, String calendarLocation, String calendarAttenders,
                       String calendarCategory, String calendarOpenYn, int fkMembersCalendars, int fkSprintsCalendars) {
        ...
        this.calendarAlarmCycle = calendarAlarmCycle;
    ...
    public String getCalendarAlarmCycle() {
        return calendarAlarmCycle;
    }

    public void setCalendarAlarmCycle(String calendarAlarmCycle) {
        this.calendarAlarmCycle = calendarAlarmCycle;
    }
    ...
    public String toString() {
        return "CalendarDTO{" +
                ...
                ", calendarAlarmCycle='" + calendarAlarmCycle + '\'' +
