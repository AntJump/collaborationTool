...
public class InvitationService  {
    ...
    public Object registerProjectMemberByInvitation(InvitationDto invitationDto) {
        ...
        // 프로젝트 정보 얻어오기
//        ProjectAndMemberDto projectAndMemberDto = projectMapper.selectProjectById(invitationDto.getFkProjectsProjectId());
//        System.out.println("projectAndMemberDto: "+projectAndMemberDto);

        int result =  projectMapper.registProjectMember(projectMemberDto);
        return (result>0) ? " 해당 프로젝트 팀원으로 등록 성공" : "해당 프로젝트 팀원 등록 실패";
    }
