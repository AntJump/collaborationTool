    ...
    <>
      ...
      <Modal open={open} onClose={handleClose}>
        <Box sx={modalBoxStyle({ w: "600px", h: "600px" })}>
          <ModalHeader
            title={`스프린트 시작 | 포함된 이슈(${includedIssues.length}개)`}
          ...
          <Grid container spacing={1} height="80%">
            ...
            <Grid item xs={12} height="85%">
              <SprintStartInfoForm sprintId={sprintId} />
            </Grid>
            <Grid item xs={12}>
              <Button
                color="grey"
              ...
              <SprintMemberSelectModal
                includedIssues={includedIssues}
                beforeHandleClose={handleClose}
              />
            </Grid>
          </Grid>
        </Box>
