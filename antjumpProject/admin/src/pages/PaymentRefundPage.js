...
function PaymentDetailPage() {
    ...
    const onClickRefundHandler = () => {        
        console.log('[PaymentDetailPage] onClickRefundHandler Start!!');

        dispatch(callPaymentDetailAPI({
        ...
        console.log('[PaymentDetailPage] onClickRefundHandler End!!');
    ...
    return payment && (
        <>
          ...
          <Box sx ={{mt: 15}}>
            ...
            <CustomButton variant="contained" disableElevation onClick={onClickRefundHandler}>
                환불 요청
            </CustomButton>
        </>
    );
